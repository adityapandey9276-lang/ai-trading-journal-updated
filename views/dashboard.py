...
def show(user):
    ...
    with c2:
        st.markdown("<div class='mp-card' style='padding:1rem;'>", unsafe_allow_html=True)
        st.plotly_chart(win_rate_gauge(s["win_rate"]), use_container_width=True)
        st.markdown("</div>", unsafe_allow_html=True)
    ...
    with c3:
        st.markdown("<div class='mp-card' style='padding:1rem;'>", unsafe_allow_html=True)
        st.plotly_chart(pnl_bar(df), use_container_width=True)
        st.markdown("</div>", unsafe_allow_html=True)
    with c4:
        st.markdown("<div class='mp-card' style='padding:1rem;'>", unsafe_allow_html=True)
        st.plotly_chart(symbol_pie(df), use_container_width=True)
        st.markdown("</div>", unsafe_allow_html=True)
